...
#ifndef DEVICES_ZCUADRV9009_DEVICEZCUADRV9009_H_
#define DEVICES_ZCUADRV9009_DEVICEZCUADRV9009_H_
...
class DEVICES_API DeviceZcuadrv9009
{
public:
    static DeviceZcuadrv9009& instance();
    ...
    DeviceZcuadrv9009Box* getDeviceFromURI(const std::string& uri);
    DeviceZcuadrv9009Box* getDeviceFromSerial(const std::string& serial);
...
private:
    DeviceZcuadrv9009Scan m_scan;
};

#endif /* DEVICES_ZCUADRV9009_DEVICEZCUADRV9009_H_ */
