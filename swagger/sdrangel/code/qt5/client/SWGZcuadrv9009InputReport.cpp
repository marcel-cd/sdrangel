...
SWGZcuadrv9009InputReport::SWGZcuadrv9009InputReport(QString* json) {
    init();
    this->fromJson(*json);
}

SWGZcuadrv9009InputReport::SWGZcuadrv9009InputReport() {
    adc_rate = 0;
...
void
SWGZcuadrv9009InputReport::init() {
    adc_rate = 0;
    m_adc_rate_isSet = false;
    rssi = new QString("");
    m_rssi_isSet = false;
...
void
SWGZcuadrv9009InputReport::cleanup() {
...
SWGZcuadrv9009InputReport::fromJson(QString &json) {
...
void
SWGZcuadrv9009InputReport::fromJsonObject(QJsonObject &pJson) {
...
QString
SWGZcuadrv9009InputReport::asJson ()
{
...
QJsonObject*
SWGZcuadrv9009InputReport::asJsonObject() {
...
qint32
SWGZcuadrv9009InputReport::getAdcRate() {
    return adc_rate;
}
void
SWGZcuadrv9009InputReport::setAdcRate(qint32 adc_rate) {
    this->adc_rate = adc_rate;
    this->m_adc_rate_isSet = true;
}

QString*
SWGZcuadrv9009InputReport::getRssi() {
    return rssi;
}
void
SWGZcuadrv9009InputReport::setRssi(QString* rssi) {
    this->rssi = rssi;
    this->m_rssi_isSet = true;
}

qint32
SWGZcuadrv9009InputReport::getGainDb() {
    return gain_db;
}
void
SWGZcuadrv9009InputReport::setGainDb(qint32 gain_db) {
    this->gain_db = gain_db;
    this->m_gain_db_isSet = true;
}

float
SWGZcuadrv9009InputReport::getTemperature() {
    return temperature;
}
void
SWGZcuadrv9009InputReport::setTemperature(float temperature) {
...
bool
SWGZcuadrv9009InputReport::isSet(){
