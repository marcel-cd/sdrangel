...
SWGDeviceReport::SWGDeviceReport() {
    ...
    zcu_adrv9009_input_report = nullptr;
    m_zcu_adrv9009_input_report_isSet = false;
...
SWGDeviceReport::init() {
    ...
    m_pluto_sdr_mimo_report_isSet = false;
    zcu_adrv9009_input_report = new SWGZcuadrv9009InputReport();
    m_zcu_adrv9009_input_report_isSet = false;
...
SWGDeviceReport::cleanup() {
    ...
    if(zcu_adrv9009_input_report != nullptr) {
        delete zcu_adrv9009_input_report;
    }
...
SWGDeviceReport::fromJsonObject(QJsonObject &pJson) {
    ...
    ::SWGSDRangel::setValue(&zcu_adrv9009_input_report, pJson["zcuadrv9009InputReport"], "SWGZcuadrv9009InputReport", "SWGZcuadrv9009InputReport");
...
SWGDeviceReport::asJsonObject() {
    ...
    if((zcu_adrv9009_input_report != nullptr) && (zcu_adrv9009_input_report->isSet())){
        toJsonValue(QString("zcuadrv9009InputReport"), zcu_adrv9009_input_report, obj, QString("SWGzcuadrv9009InputReport"));
    }
...
SWGDeviceReport::getZcuadrv9009InputReport() {
    return zcu_adrv9009_input_report;
}
void
SWGDeviceReport::setZcuadrv9009InputReport(SWGZcuadrv9009InputReport* zcu_adrv9009_input_report) {
    this->zcu_adrv9009_input_report = zcu_adrv9009_input_report;
    this->m_zcu_adrv9009_input_report_isSet = true;
}
...
SWGDeviceReport::isSet(){
    ...
    do{
        ...
        if(zcu_adrv9009_input_report && zcu_adrv9009_input_report->isSet()){
            isObjectUpdated = true; break;
        }
