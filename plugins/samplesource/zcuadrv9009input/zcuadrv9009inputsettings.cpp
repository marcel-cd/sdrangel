...
Zcuadrv9009InputSettings::Zcuadrv9009InputSettings()
{
	resetToDefaults();
}

void Zcuadrv9009InputSettings::resetToDefaults()
{
...
QByteArray Zcuadrv9009InputSettings::serialize() const
{
...
bool Zcuadrv9009InputSettings::deserialize(const QByteArray& data)
{
...
void Zcuadrv9009InputSettings::translateRFPath(RFPath path, QString& s)
{
    switch(path)
    {
    case RFPATH_A_BAL:
...
void Zcuadrv9009InputSettings::translateGainMode(GainMode mode, QString& s)
{
    switch(mode)
    {
    case GAIN_MANUAL:
...
void Zcuadrv9009InputSettings::applySettings(const QStringList& settingsKeys, const Zcuadrv9009InputSettings& settings)
{
...
QString Zcuadrv9009InputSettings::getDebugString(const QStringList& settingsKeys, bool force) const
{
