...
#ifndef PLUGINS_SAMPLESOURCE_ZCUADRV9009INPUT_ZCUADRV9009INPUTGUI_H_
#define PLUGINS_SAMPLESOURCE_ZCUADRV9009INPUT_ZCUADRV9009INPUTGUI_H_
...
namespace Ui {
    class Zcuadrv9009InputGUI;
}

class Zcuadrv9009InputGui : public DeviceGUI {
    Q_OBJECT

public:
    explicit Zcuadrv9009InputGui(DeviceUISet *deviceUISet, QWidget* parent = 0);
    virtual ~Zcuadrv9009InputGui();
...
#endif /* PLUGINS_SAMPLESOURCE_ZCUADRV9009INPUT_ZCUADRV9009INPUTGUI_H_ */
