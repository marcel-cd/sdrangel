...
#ifndef _ZCUADRV9009_ZCUADRV9009INPUTSETTINGS_H_
#define _ZCUADRV9009_ZCUADRV9009INPUTSETTINGS_H_

#include <QtGlobal>
#include <QString>
#include <stdint.h>

struct Zcuadrv9009InputSettings {
	typedef enum {
		FC_POS_INFRA = 0,
		FC_POS_SUPRA,
		FC_POS_CENTER,
	...
	Zcuadrv9009InputSettings();
	void resetToDefaults();
	QByteArray serialize() const;
	bool deserialize(const QByteArray& data);
    static void translateRFPath(RFPath path, QString& s);
    static void translateGainMode(GainMode mod, QString& s);
    void applySettings(const QStringList& settingsKeys, const Zcuadrv9009InputSettings& settings);
    QString getDebugString(const QStringList& settingsKeys, bool force=false) const;
};

#endif /* _ZCUADRV9009_ZCUADRV9009INPUTSETTINGS_H_ */
