...
#ifndef PLUGINS_SAMPLESOURCE_ZCUADRV9009INPUT_ZCUADRV9009INPUTTHREAD_H_
#define PLUGINS_SAMPLESOURCE_ZCUADRV9009INPUT_ZCUADRV9009INPUTTHREAD_H_
...
class DeviceZcuadrv9009Box;

class Zcuadrv9009InputThread : public QThread, public DeviceZcuadrv9009Shared::ThreadInterface
{
    Q_OBJECT

public:
    Zcuadrv9009InputThread(uint32_t blocksize, DeviceZcuadrv9009Box* plutoBox, SampleSinkFifo* sampleFifo, QObject* parent = 0);
    ~Zcuadrv9009InputThread();
...
private:
    ...
    DeviceZcuadrv9009Box *m_plutoBox;
...
#endif /* PLUGINS_SAMPLESOURCE_ZCUADRV9009INPUT_ZCUADRV9009INPUTTHREAD_H_ */
